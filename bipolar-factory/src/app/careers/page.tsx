export default function CareersPage() {
  return (
    <main style={{ background: 'var(--bg)', color: 'var(--text)', minHeight: '100vh', padding: '56px 48px' }}>
      <p style={{ color: 'var(--accent)', letterSpacing: '0.12em', fontSize: 12, marginBottom: 12 }}>CAREERS</p>
      ...
      <a href="mailto:hello@bipolarfactory.com?subject=Careers%20at%20Bipolar%20Factory" style={{ color: 'var(--accent-text)', background: 'var(--accent)', padding: '12px 20px', borderRadius: 999, textDecoration: 'none' }}>
        Send your profile
      </a>
    </main>
  )
