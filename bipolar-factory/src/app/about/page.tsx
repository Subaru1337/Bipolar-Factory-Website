...
export default function AboutPage() {
  ...
  return (
    <div ref={pageRef} style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--text)' }}>
      ...
      {/* Hero */}
      <div style={{ padding: '140px 48px 80px', borderBottom: '0.5px solid var(--border)', maxWidth: 1400, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
        <div>
          <p className="page-eyebrow" style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, fontWeight: 500, color: 'var(--accent)', letterSpacing: '0.18em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32 }}>
      ...
      <div style={{ display: 'flex', borderBottom: '0.5px solid var(--border)' }}>
        {[
          ...
          <div key={s.label} style={{
            ...
            <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 48, color: 'var(--text)', letterSpacing: '-0.04em', lineHeight: 1, marginBottom: 8 }}>{s.value}</div>
      ...
      {/* Services summary */}
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '100px 48px', borderBottom: '0.5px solid var(--border)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80 }}>
        <div>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'var(--accent)', letterSpacing: '0.18em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
            <span style={{ display: 'block', width: 24, height: 1, background: 'var(--accent)' }} />
            What we do
          </p>
        ...
        <div style={{ paddingTop: 60 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {markets.map(m => (
              <span key={m} style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 13, color: 'var(--muted)', border: '0.5px solid var(--border)', padding: '8px 16px', borderRadius: 100 }}>{m}</span>
            ))}
          </div>
        </div>
      </div>
      ...
      {/* Values */}
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '100px 48px', borderBottom: '0.5px solid var(--border)' }}>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'var(--accent)', letterSpacing: '0.18em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          <span style={{ display: 'block', width: 24, height: 1, background: 'var(--accent)' }} />
          Our values
        </p>
        ...
        <div className="values-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 2 }}>
          {values.map((v, i) => (
            <div key={v.name} className="value-card" style={{
              ...
              <span style={{ display: 'block', width: 4, height: 4, borderRadius: '50%', background: 'var(--accent)', marginBottom: 20 }} />
              <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 18, letterSpacing: '-0.02em', color: 'var(--text)', marginBottom: 10 }}>{v.name}</h3>
      ...
      {/* Mission */}
      <div className="mission-block" style={{ maxWidth: 1400, margin: '0 auto', padding: '100px 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center', borderBottom: '0.5px solid var(--border)' }}>
        <div>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'var(--accent)', letterSpacing: '0.18em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
            <span style={{ display: 'block', width: 24, height: 1, background: 'var(--accent)' }} />
            Our mission
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 72, color: 'var(--accent)', lineHeight: 1, letterSpacing: '-0.04em', marginBottom: 16, opacity: 0.15 }}>"</div>
          <p style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 28, color: 'var(--text)', letterSpacing: '-0.02em', lineHeight: 1.2 }}>
            For the world.
          </p>
